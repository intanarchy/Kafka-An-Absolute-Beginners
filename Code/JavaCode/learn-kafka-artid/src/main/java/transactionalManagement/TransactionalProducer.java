...
public class TransactionalProducer {
    ...
    public static void main(String[] args) {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:5091,localhost:5092,localhost:5093");
        ...
        try {
            ...
            while (true) {
                ...
                producer.send(new ProducerRecord<>("transactionmgmnt02", key, value));
