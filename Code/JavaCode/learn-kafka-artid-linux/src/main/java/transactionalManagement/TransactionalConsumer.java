...
public class TransactionalConsumer {
    ...
    public static void main(String[] args) {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:6091,localhost:6092,localhost:6093");
        ...
        consumer.subscribe(Collections.singletonList("transactionmgmnt03"));
