...
public class CustomKafkaConsumer {
    private static final String TOPIC = "transactionmgmnt03";
	...
	public static void main(String[] args) {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:6091,localhost:6092,localhost:6093"); // List your Kafka brokers
